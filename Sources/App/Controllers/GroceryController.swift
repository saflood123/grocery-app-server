...
class GroceryController: RouteCollection {
    ...
    func boot(routes: RoutesBuilder) throws {
        ...
        func saveGroceryItem(req: Request) async throws -> GroceryItemResponseDTO {
            ...
            let groceryItem = GroceryItem(title: groceryItemRequestDTO.title, price: groceryItemRequestDTO.price,
                reps: groceryItemRequestDTO.reps,
                quantity: groceryItemRequestDTO.quantity, groceryCategoryId: groceryCategory.id!,dateofbirth: groceryItemRequestDTO.dateofbirth, date_updated: groceryItemRequestDTO.date_updated)
        ...
        func saveGroceryItem3(req: Request) async throws -> GroceryItem3ResponseDTO {
            ...
            let groceryItem3 = GroceryItem3(title: groceryItem3RequestDTO.title, price: groceryItem3RequestDTO.price, quantity: groceryItem3RequestDTO.quantity,foodtype: groceryItem3RequestDTO.foodtype, groceryCategoryId: groceryCategory.id!,dateofbirth: groceryItem3RequestDTO.dateofbirth, date_updated: groceryItem3RequestDTO.date_updated)
