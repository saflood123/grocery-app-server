...
extension GroceryItem2ResponseDTO: Content {
    ...
    init?(_ groceryItem: GroceryItem2) {
        ...
        self.init(id: groceryItemId, title: groceryItem.title,price: groceryItem.price, quantity: groceryItem.quantity, dateofbirth: groceryItem.dateofbirth, date_updated: groceryItem.date_updated)
    }
}
